...
public class Firma implements Serializable {
	...
	@OneToMany(cascade = { CascadeType.ALL, CascadeType.PERSIST, CascadeType.MERGE }, mappedBy = "firma", orphanRemoval=true)
	...
	public void setIme(String ime) throws Exception {
		 Pattern pattern = Pattern.compile("[a-zA-ZĐđŠšČčĆćŽž0-9\\s\\.]{3,}"); //mogu se unijeti mala, velika slova, brojevi, i tacka
